...
export const processLinkedItemsElement = (linkedItemsElement: ContentItem[]) =>
    linkedItemsElement.map((contentItem: ContentItem) => contentItem.system.codename);

export const processTaxonomyElement = (taxonomyElement: Fields.TaxonomyField) =>
    taxonomyElement.taxonomyTerms.map((term: FieldModels.TaxonomyTerm) => term.name);

export const processMultipleChoiceElement = (multipleChoiceElement: Fields.MultipleChoiceField) =>
